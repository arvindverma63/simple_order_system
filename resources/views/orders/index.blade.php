        ...
        <div class="bg-white/95 backdrop-blur-lg p-6 rounded-2xl shadow-2xl max-w-sm w-full text-center">
            ...
            <div class="flex justify-center space-x-4">
                <button id="confirm-delete"
                    class="bg-red-600 text-white py-2 px-4 rounded-lg font-bold hover:bg-red-700 transition duration-300">Delete</button>
        ...
        <div class="bg-white/95 backdrop-blur-lg p-6 rounded-2xl shadow-2xl max-w-sm w-full text-center">
            ...
            <div class="flex justify-center space-x-4">
                <button id="confirm-status"
                    class="bg-blue-600 text-white py-2 px-4 rounded-lg font-bold hover:bg-blue-700 transition duration-300">Update</button>
